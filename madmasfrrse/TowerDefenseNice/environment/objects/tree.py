...
class Tree(GameObject):
    ...
    def _load_sprite(self):
        ...
        tree_sprites = [
            'assets/sprites/environment/trees/tree(1).png',
            'assets/sprites/environment/trees/tree(2).png',
            'assets/sprites/environment/trees/tree(3).png',
            'assets/sprites/environment/trees/tree(4).png',
        ]
        sprite_path = random.choice(tree_sprites)
